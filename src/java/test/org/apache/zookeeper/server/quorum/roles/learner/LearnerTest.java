...
public class LearnerTest extends ZKTestCase {
    ...
    static class SimpleLearnerZooKeeperServer extends LearnerZooKeeperServer {
        ...
        public SimpleLearnerZooKeeperServer(FileTxnSnapLog ftsl, QuorumPeer self)
                throws IOException {
            super(ftsl, new ZKDatabase(ftsl), self);
        }
    ...
    public void syncTest() throws Exception {
        ...
        try {
            ...
            QuorumPacket qp = new QuorumPacket(OpOfLeader.SNAP.intType(), 0, null, null);
            oa.writeRecord(qp, null);
            sl.zk.getZKDatabase().serializeSnapshot(oa);
            oa.writeString("BenWasHere", "signature");
            TxnHeader hdr = new TxnHeader(0, 0, 0, 0, OpType.create.getValue());
            ...
            tbaos.close();
            qp = new QuorumPacket(OpOfLeader.PROPOSAL.intType(), 1, tbaos.toByteArray(), null);
            oa.writeRecord(qp, null);
