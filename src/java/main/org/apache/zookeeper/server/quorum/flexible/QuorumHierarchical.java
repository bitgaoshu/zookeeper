 ...
 * each processor has a weight. We obtain a quorum if we get more than half
 ...
 * a colon-separated list of processor ids. It is also necessary to assign
 * weights to processor. Here is an example of a configuration that creates
 * three groups and assigns a weight of 1 to each processor:
 * 
 *  group.1=1:2:3
 *  group.2=4:5:6
 *  group.3=7:8:9
 ...
 *  weight.9=1
 * 
 * Note that it is still necessary to define peers using the processor keyword.
 */
...
public class QuorumHierarchical implements QuorumVerifier {
   ...
   public boolean equals(Object o){
    ...
    /**
     * Returns the weight of a processor.
     * 
     * @param id
     */
    ...
    public String toString(){
       ...
       for (QuorumServer member: getAllMembers().values()){            
               String key = "processor." + member.id;
