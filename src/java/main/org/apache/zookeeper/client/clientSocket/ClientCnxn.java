...
import org.apache.zookeeper.client.clientSocket.watchManager.ClientWatchManager;
...
public class ClientCnxn {
    ...
    public SocketAddress getSendThreadRemoteAddress() {
        return sendThread.getClientCnxnSocket().getRemoteSocketAddress();
    }

    public SocketAddress getSendThreadLocalAddress() {
        return sendThread.getClientCnxnSocket().getLocalSocketAddress();
    }
    ...
    public void setSeenRwServerBefore(boolean seenRwServerBefore) {
        this.seenRwServerBefore = seenRwServerBefore;
    }


    public void queueEvent(WatchedEvent watchedEvent) {
        eventThread.queueEvent(watchedEvent);
    }
    ...
    public void testableCloseSocket() throws IOException {
        sendThread.getClientCnxnSocket().testableCloseSocket();
    }
